    ...
    <div id="carouselExampleSlidesOnly" className = "carousel slide" data-bs-ride="carousel">
      <div className = "carousel-inner">
        ...
        <div className = "carousel-item">
          ...
          <img src="hardware3.jpg" className = "d-block w-100" alt="empty cell" style={heightstyle}/>
        </div>
        <div className = "carousel-item">
          <div className = "imgtitle">
            Mobile Phones
          </div>
          <img src="elec7_app.jpg" className = "d-block w-100" alt="empty cell" style={heightstyle}/>
        </div>
        <div className = "carousel-item">
          <div className = "imgtitle">
            Furniture
        ...
        <div className = "carousel-item">
          ...
          <img src="fashion5.jpg" className = "d-block w-100" alt="..." style={heightstyle}/>
        </div>
        <div className = "carousel-item">
          <div className = "imgtitle">
            Hardware Tools
          </div>
          <img src="hardware3.jpg" className = "d-block w-100" alt="..." style={heightstyle}/>
        </div>
